...
const en: PricingDict = {
  ...
  startFree: "Start for €1", contactUs: "Contact us", customPrice: "Let’s talk",
  trial: "€1 first month", noCard: "No contract", cancel: "Cancel anytime",
...
const pt: PricingDict = {
  ...
  startFree: "Começar por 1€", contactUs: "Fale conosco", customPrice: "Personalizado",
  trial: "1€ no 1.º mês", noCard: "Sem contrato", cancel: "Cancele quando quiser",
...
const es: PricingDict = {
  ...
  startFree: "Empezar por 1€", contactUs: "Contactar", customPrice: "A medida",
  trial: "1€ primer mes", noCard: "Sin contrato", cancel: "Cancela cuando quieras",
...
const fr: PricingDict = {
  ...
  startFree: "Commencer pour 1€", contactUs: "Nous contacter", customPrice: "Sur devis",
  trial: "1€ premier mois", noCard: "Sans engagement", cancel: "Résiliez à tout moment",
...
const it: PricingDict = {
  ...
  startFree: "Inizia per 1€", contactUs: "Contattaci", customPrice: "Su misura",
  trial: "1€ primo mese", noCard: "Senza contratto", cancel: "Disdici quando vuoi",
...
const de: PricingDict = {
  ...
  startFree: "Start für 1€", contactUs: "Kontakt", customPrice: "Auf Anfrage",
  trial: "1€ im ersten Monat", noCard: "Kein Vertrag", cancel: "Jederzeit kündigen",
