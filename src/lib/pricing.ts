...
const en: PricingDict = {
  ...
  insightBody: "An Airbnb earns ~€1,500/mo per property. Our 5-property plan costs €19.99 — 1.3% of your revenue.",
...
const pt: PricingDict = {
  ...
  insightBody: "Um Airbnb rende ~R$ 2.000/mês por imóvel. O plano de 5 imóveis custa R$ 49,90 — 2,5% da sua receita.",
...
const es: PricingDict = {
  ...
  insightBody: "Un Airbnb genera ~€1.500/mes por propiedad. El plan de 5 cuesta €19,99 — 1,3% de tus ingresos.",
...
const fr: PricingDict = {
  ...
  insightBody: "Un Airbnb génère ~1 500 €/mois par bien. Le plan 5 biens coûte 19,99 € — 1,3% de vos revenus.",
...
const it: PricingDict = {
  ...
  insightBody: "Un Airbnb genera ~1.500 €/mese per immobile. Il piano 5 immobili costa 19,99 € — 1,3% del tuo fatturato.",
...
const de: PricingDict = {
  ...
  insightBody: "Ein Airbnb erzielt ~1.500 €/Mon. pro Immobilie. Der 5-Immobilien-Plan kostet 19,99 € — 1,3% des Umsatzes.",
