...
const en: PricingDict = {
  ...
  insightBody: "A short-term rental earns ~€1,500/mo per property. Our 5-property plan costs €24.99 — 1.3% of your revenue.",
...
const es: PricingDict = {
  ...
  insightBody: "Un alojamiento local genera ~€1.500/mes por propiedad. El plan de 5 cuesta €24,99 — 1,3% de tus ingresos.",
