...
const pt: LandingCopy = {
  ...
  hero: {
    headline: "Seu alojamento local, organizado em 2 minutos por dia.",
  ...
  problem: {
    ...
    rows: [
      { bad: "Manda WhatsApp pra faxineira e nunca sabe se foi feito", good: "Faxineira recebe checklist no celular — fotos enviadas pro seu e-mail automaticamente" },
      ...
      { bad: "Não faz ideia do que está acontecendo sem ligar pra alguém", good: "Painel em tempo real de todos os imóveis numa só tela" },
  ...
  how: {
    ...
    steps: [
      { number: "1", title: "Cadastre seu imóvel", desc: "2 minutos. Ou importe uma planilha." },
      { number: "2", title: "Convide sua faxineira", desc: "Ela recebe um link. Sem app. Sem conta. Só clica." },
      { number: "3", title: "Gerencie pelo celular", desc: "Status em tempo real, alertas automáticos, pronto." },
    ],
  },
  features: {
    title: "Tudo que você precisa. Nada que você não precisa.",
    cards: [
      { icon: "🧹", title: "Fotos enviadas direto pro seu e-mail", desc: "Sem limite de armazenamento. Qualidade total. Seu inbox vira o arquivo." },
      { icon: "⏱️", title: "Saiba exatamente quanto demora cada limpeza", desc: "Cobre a taxa de limpeza com justiça. Dados reais da equipe." },
      { icon: "📦", title: "Objetos esquecidos com alerta foto instantâneo", desc: "Nunca mais perca nada. Foto chega no momento que é encontrado." },
      { icon: "🔴", title: "Problemas de manutenção reportados pela faxineira", desc: "Foto + descrição direto no seu e-mail." },
      { icon: "📅", title: "Calendário com reservas, limpezas e checkouts", desc: "Uma só tela. Tudo num só lugar." },
      { icon: "💰", title: "Financeiro simples — receita, despesa, lucro por imóvel", desc: "Automático. Sem planilha." },
      { icon: "👥", title: "Perfis de hóspedes com tags", desc: "VIP, recorrente, atenção — visível num piscar de olhos." },
      { icon: "🏆", title: "Score de organização da operação", desc: "Veja o quão organizado você está e o que melhorar." },
      { icon: "🔗", title: "Sincroniza com Airbnb e Booking.com", desc: "Cole um link iCal — calendários ficam alinhados automaticamente." },
    ],
  },
  social: {
    ...
    testimonials: [
      ...
      { quote: "As fotos da limpeza enviadas direto pro meu e-mail mudaram tudo. Vejo cada cômodo.", name: "James T.", props: "2 properties · Miami", flag: "🇺🇸" },
  ...
  faq: {
    ...
    items: [
      { q: "Não tenho tempo de aprender outro app.", a: "Configure em 5 minutos. A faxineira nem precisa de conta — é só clicar num link." },
      { q: "Minha faxineira não é boa com tecnologia.", a: "Ela recebe um link. Abre o navegador. Tira fotos. Pronto. Sem app. Sem senha." },
      { q: "E as fotos? Onde elas ficam?", a: "As fotos vão direto pro seu e-mail em qualidade total. Seu inbox vira seu arquivo de limpezas — ilimitado, pesquisável, sempre disponível." },
      { q: "Já tenho uma planilha que funciona.", a: "Planilha não te alerta sobre checkouts. Não envia fotos. Não te notifica sobre manutenção." },
      { q: "É caro?", a: "Plano grátis é permanente — não é teste. Pro custa menos que uma diária. Cancele em 1 clique se não gostar." },
      { q: "E se eu tiver imóveis em países diferentes?", a: "Funciona em qualquer país, 6 idiomas, moeda local." },
      { q: "Funciona com Airbnb e Booking.com?", a: "Sim. Cole seu link iCal de qualquer plataforma — calendários ficam sincronizados automaticamente." },
    ],
  },
  progress: {
