...
const pt: Dict = {
  ...
  "pricing.plan.f4": "Importação por planilha (Excel/CSV)",
...
const en: Dict = {
  ...
  "pricing.plan.f4": "Spreadsheet import (Excel/CSV)",
...
const es: Dict = {
  ...
  "pricing.plan.f4": "Importación por hoja de cálculo (Excel/CSV)",
