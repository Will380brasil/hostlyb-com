...
const DICTS: Record<Lang, Dict> = {
  pt: {
    ...
    "hero.badge": "✦ Gestão de Airbnb simplificada",
    "hero.title.a": "Chega de",
    "hero.title.b": "caos",
    "hero.title.c": "na gestão do seu Airbnb.",
    "hero.subtitle": "Controle limpezas, hóspedes e profissionais num só lugar. 7 dias grátis para testar.",
    "hero.cta": "Começar 7 dias grátis",
    "hero.demo": "Ou explore a demo →",
    "hero.bullet1": "✓ Sem cartão de crédito",
    "hero.bullet2": "✓ Cancele quando quiser",
    "hero.bullet3": "✓ Setup em 5 minutos",
    "social.proof": "Usado por mais de 2.400 anfitriões no Brasil, EUA e Europa",
    "pricing.title.a": "Preço honesto.",
    "pricing.title.b": "Sem surpresas.",
    "pricing.subtitle": "Um plano simples, com tudo que você precisa.",
    ...
    "pricing.plan.f5": "Alertas automáticos",
    "pricing.plan.f6": "App da faxineira por link",
    "pricing.plan.f7": "Suporte por e-mail",
    "pricing.cta": "Começar 7 dias grátis",
    "pricing.note": "✓ 7 dias grátis  ✓ Sem cartão  ✓ Cancele quando quiser",
    "cta.title": "Comece a gerenciar como um profissional.",
    "cta.subtitle": "7 dias grátis. Sem cartão. Sem complicação.",
